...
class CodeManage:
    ...
    def generate_access_code(self, user_id: str, movie_id: int, expiration_date: datetime) -> str:
        random_code = self.__generate_random_code()

        self.db.insert_access_code(random_code, movie_id, user_id, expiration_date)
